...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue Jun 24 13:47:44 2014
# Project:  TryCpp.pro
# Template: app
# Command: c:\qtsdk\desktop\qt\4.8.1\mingw\bin\qmake.exe -spec c:\QtSDK\Desktop\Qt\4.8.1\mingw\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile TryCpp.pro
#############################################################################
...
Makefile: TryCpp.pro  c:/QtSDK/Desktop/Qt/4.8.1/mingw/mkspecs/win32-g++/qmake.conf c:/QtSDK/Desktop/Qt/4.8.1/mingw/mkspecs/qconfig.pri \
	...
	$(QMAKE) -spec c:\QtSDK\Desktop\Qt\4.8.1\mingw\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile TryCpp.pro
